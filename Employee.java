...
public class Employee {
	...
	private ArrayList<Task2> userTasks; //List of tasks completed by user
	
	public Employee(String userName, int userTeam) {
		this.userName = userName;
		this.userTeam = userTeam;
		this.userTasks = new ArrayList<Task2>();
	...
	public ArrayList<Task2> getTasks() {
		return userTasks;
	} //Returns the ArrayList of tasks
	
	public void addUserTask(Task2 newTask) {
		userTasks.add(newTask);
	} //adds a completed task to the employee's list of tasks
	
	public void importTaskList(ArrayList<Task2> importedList) {
