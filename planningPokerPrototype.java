...
public class planningPokerPrototype {
		...
		do {
			...
			case 'B':  //display the current user story
				System.out.println("Current user story: A user is attemtping to search through their files"
			...
			case 'P': //save the current user story and vote data to a output file for backup.
				...
				try {
                    ...
                    buffer.write("This session's user story: A user is attemtping to search through their files "
    						+ "and wants a way to search or filter their files via keywords.\n"
